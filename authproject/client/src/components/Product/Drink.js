...
function Drink () {
    ...
    const drink= allproduct && allproduct.filter((el)=>el.Category==="drink")
    console.log(drink,"rrrrrrr")
    return(
    <>
    ...
    <div className="container-fluid  mb-5">
        <div className="d-flex flex-column align-items-center justify-content-center" style={{minHeight: "300px",backgroundColor:"rgb(77, 148, 93)",marginTop:"10%",padding:"5px"}}>
            <h1 className="font-weight-semi-bold text-uppercase mb-3"style={{color:"white"}}>Drink</h1>
            ...
            <div className="col-lg-9 col-md-12">
                <div className="row pb-3">
                    ...
                    <div className="text-center mb-4">
                            <h2 className="section-title px-5"><span className="px-2">Drink</span></h2>
                        </div>
                    <div style={{display:"flex",flex:"wrap",marginRight: "-15px",marginLeft: "-15px;"}}>
                        
                        { drink && drink.map(filteredCategory=> (
