...
function Rice () {
    ...
    const rice=allproduct && allproduct.filter((el)=>el.Category==="rice")
    console.log(rice,"rrrrrrr")
    return(
            ...
            <div className="container-fluid  mb-5">
                <div className="d-flex flex-column align-items-center justify-content-center" style={{minHeight: "300px",backgroundColor:"rgb(77, 148, 93)",marginTop:"10%",padding:"5px"}}>
                    <h1 className="font-weight-semi-bold text-uppercase mb-3"style={{color:"white"}}>Rice</h1>
